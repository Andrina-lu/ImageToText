...
parser.add_argument('-B', '--background', default='origin7',
                    choices=['transparent', 'black', 'mean', 'white', 'origin5', 'origin6', 'origin7', 'origin8'])
parser.add_argument('-S', '--seed', type=int,
                    help='set the seed of randomly generated texts')                    
parser.add_argument('--alphabet', default='uppercase',
                    choices=['uppercase', 'lowercase', 'alphabet', 'number', 'alphanumeric', 'symbol', 'random'],
